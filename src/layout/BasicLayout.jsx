                    ...
                    <ul>
                        ...
                        <li className="relative px-6 py-3">
                            ...
                            >
                                ...
                                <svg
                                    className={`w-4 h-4 ml-auto transition-transform duration-150 ${isPagesMenuOpen ? 'transform rotate-180' : ''
                                    }`}
                                ...
                                <ul className="mt-2">
                                    ...
                                    <li className="relative px-6 py-3">
                                        <a
                                            ...
                                            href="blank.html"
                                        >
                                            <span className="ml-4">Blank</span>
                                        </a>
                                    </li>
                                    <li className="relative px-6 py-3">
                                        <a
