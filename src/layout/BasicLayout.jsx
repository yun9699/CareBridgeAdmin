...
function BasicLayout({ children }) {
    ...
    return (
        <div className="flex h-screen bg-green-50">
            {/* 사이드바 */}
            <aside
                className={`bg-green-800 text-green-100 w-64 space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform ${
            ...
            {/* 모바일 메뉴 토글 버튼 */}
            <button
                className="md:hidden fixed top-4 left-4 z-20 p-2 bg-green-800 text-white rounded"
